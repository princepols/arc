...
def sanitize_response(text: str) -> str:
    """Clean AI output before returning to frontend or saving to DB."""
...
MODE_PROMPTS = {
    "general": (
        ...
        "- IMPORTANT — Markdown table rules: Never use bullet points, line breaks, or newlines inside table cells. "
        "Use semicolons (;) to separate multiple items within a single cell. "
    ...
    async def send_message(
        ...
        async with httpx.AsyncClient(timeout=60.0, verify=False) as client:
            ...
            try:
                ...
                return sanitize_response(text.strip())
